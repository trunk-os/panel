...
export default function ComputeStorageCard({ collapsed = false }: ComputeStorageCardProps) {
  ...
  const usedDisk = totalDisk && availableDisk !== undefined ? Math.max(0, totalDisk - availableDisk) : undefined;
  const diskUsagePercent = totalDisk && totalDisk > 0 && systemStatus?.total_disk && systemStatus?.available_disk !== undefined ? Math.round(((systemStatus.total_disk - systemStatus.available_disk) / systemStatus.total_disk) * 100) : undefined;
      ...
      <CardContent sx={{ display: "flex", flexDirection: "column", height: "100%", pb: 2 }}>
        ...
        {isLoading ? (
          ...
          <Box sx={{ display: "flex", flexDirection: "column", height: "100%" }}>
            ...
            <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", flexGrow: 1, py: 2, px: 1 }}>
                ...
                <Box sx={{ textAlign: "center", width: "100%" }}>
                  ...
                  <Box sx={{ width: "80%", mx: "auto" }}>
                    <LinearProgress
                      ...
                      color={diskUsagePercent && diskUsagePercent > 90 ? "error" : diskUsagePercent && diskUsagePercent > 70 ? "warning" : "info"}
