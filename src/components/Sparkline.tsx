...
import { LineChart, Line, ResponsiveContainer, YAxis, Area, AreaChart, ReferenceLine } from "recharts";
      ...
      <Box sx={{ width, height, p: 0.5 }}>
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={chartData}>
            ...
            <ReferenceLine y={stats.yAxisMax} stroke={color} strokeOpacity={0.2} strokeWidth={0.5} />
            <ReferenceLine y={stats.yAxisMax * 0.75} stroke={color} strokeOpacity={0.1} strokeWidth={0.5} />
            <ReferenceLine y={stats.yAxisMax * 0.5} stroke={color} strokeOpacity={0.15} strokeWidth={0.5} />
            <ReferenceLine y={stats.yAxisMax * 0.25} stroke={color} strokeOpacity={0.1} strokeWidth={0.5} />
